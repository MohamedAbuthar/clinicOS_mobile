// Simple Working Email Service - Works without configuration
// This service generates OTP and shows it clearly for testing
...
// Send OTP (with fallback for testing)
export const sendOTPSimple = async (email: string): Promise<{ success: boolean; message: string; otp?: string }> => {
  try {
