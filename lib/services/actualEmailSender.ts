// Actual Email Sender - Sends real emails to user's inbox
...
export const sendOTPToActualEmail = async (email: string): Promise<{ success: boolean; message: string; otp?: string }> => {
  try {
