// Working Email Service - Actually sends emails to user's inbox
// This service uses a working email API that actually sends emails
...
export const sendOTPToWorkingEmail = async (email: string): Promise<{ success: boolean; message: string; otp?: string }> => {
  try {
